                ...
                <form method="POST" id="goOrder">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input id="firstNameInput" class="form-control" name="first_name" value="<?php
                                if (isset($_POST['first_name'])) {
                                    echo $_POST['first_name'];
                                } elseif (isset($users['username'])) {
                                    echo $users['username'];
                                }
                            ?>" type="text" placeholder="<?= lang('first_name') ?>">
                        </div>
                        <div class="form-group col-sm-6">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input id="emailAddressInput" class="form-control" name="email" value="<?php
                                if (isset($_POST['email'])) {
                                    echo $_POST['email'];
                                } elseif (isset($users['email'])) {
                                    echo $users['email'];
                                }
                            ?>" type="text" placeholder="<?= lang('email_address') ?>">
                        </div>
                        <div class="form-group col-sm-6">
                            <label for="phoneInput"><?= lang('phone') ?> <sup><?= lang('requires') ?></sup></label>
                            <input id="phoneInput" class="form-control" name="phone" value="<?php
                                if (isset($_POST['phone'])) {
                                    echo $_POST['phone'];
                                } elseif (isset($users_details[0]['phone'])) {
                                    echo $users_details[0]['phone'];
                                }
                            ?>" type="text" placeholder="<?= lang('phone') ?>">
                        </div>
                        <div class="form-group col-sm-12">
                            <label for="addressInput"><?= lang('address') ?> <sup><?= lang('requires') ?></sup></label>
                            <textarea id="addressInput" name="address" class="form-control" rows="3"><?php
                                if (isset($_POST['address'])) {
                                    echo $_POST['address'];
                                } elseif (isset($users_details[0]['address'])) {
                                    echo $users_details[0]['address'];
                                }
                            ?></textarea>
                        </div>
                        <div class="form-group col-sm-6">
                            <label for="cityInput"><?= lang('city') ?> <sup><?= lang('requires') ?></sup></label>
                            <input id="cityInput" class="form-control" name="city" value="<?php
                                if (isset($_POST['city'])) {
                                    echo $_POST['city'];
                                } elseif (isset($users_details[0]['city'])) {
                                    echo $users_details[0]['city'];
                                }
                            ?>" type="text" placeholder="<?= lang('city') ?>">
                        </div>
                        <div class="form-group col-sm-6">
                            <label for="postInput"><?= lang('post_code') ?></label>
                            <input id="postInput" class="form-control" name="post_code" value="<?php
                                if (isset($_POST['post_code'])) {
                                    echo $_POST['post_code'];
                                } elseif (isset($users_details[0]['post_code'])) {
                                    echo $users_details[0]['post_code'];
                                }
                            ?>" type="text" placeholder="<?= lang('post_code') ?>">
                        </div>
                        <div class="form-group col-sm-12">
