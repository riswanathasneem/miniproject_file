...
.auth-buttons .login-btn:hover {
  ...
  box-shadow: 0 2px 8px rgba(220, 25, 25, 0.3);
}
...
.auth-buttons .register-btn:hover {
  ...
  border-color: #b91515;
  transform: translateY(-1px);
  box-shadow: 0 2px 8px rgba(220, 25, 25, 0.4);
}

.auth-buttons .seller-btn {
  color: #28a745;
  border-color: #28a745;
  background-color: transparent;
}

.auth-buttons .seller-btn:hover {
  background-color: #28a745;
  border-color: #28a745;
  color: white;
  transform: translateY(-1px);
...
.modal-header {
  background: linear-gradient(135deg, #dc1919 0%, #b91515 100%);
  color: white;
...
.modal-body .form-control:focus {
  border-color: #dc1919;
  box-shadow: 0 0 0 0.2rem rgba(220, 25, 25, 0.25);
}
...
.modal-body .btn-primary:hover {
  background: linear-gradient(135deg, #b91515 0%, #a01313 100%);
  transform: translateY(-1px);
  box-shadow: 0 4px 12px rgba(220, 25, 25, 0.4);
}
...
.modal-body .input-group .input-group-append .btn {
  border-left: none;
}
...
.bag-info ul.dropdown-cart { height : auto; max-height : 250px; overflow-x : hidden; width : 450px; }
...
<body>
        ...
        <div class="row bg-secondary py-1 px-xl-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                ...
                <div class="d-inline-flex align-items-center d-block d-lg-none">
                    ...
                    <a href="<?= LANG_URL . '/shopping-cart' ?>" class="btn px-0 ml-2">
                        <i class="fas fa-shopping-cart text-dark"></i>
                        <span class="badge text-dark border border-dark rounded-circle" style="padding-bottom: 2px;"><span class="sumOfItems"><?= is_numeric($cartItems) && (int)$cartItems == 0 ? 0 : $sumOfItems ?></span></span>
    ...
    align-items: center;">
                <img src="<?= base_url('attachments/site_logo/' . $sitelogo) ?>" class="site-logo" alt="<?= $_SERVER['HTTP_HOST'] ?>" style="width:90px;">
                <span style="color:red;font-size:30px;">Craft-N</span><span style="color:black;font-size:30px">Art</span>
                </a>
            </div>
            ...
            <div class="col-lg-4 col-6 text-right d-flex align-items-center justify-content-end">
                <div class="customer-service-section mr-4">
                    <p class="m-0">Customer Service</p>
                    <h5 class="m-0">+1234</h5>
                </div>
                <div class="auth-buttons">
                    <!-- Logged out state (default) -->
                    <div id="logged-out-buttons">
                        <a href="#" class="btn btn-outline-primary btn-sm mr-1 login-btn" data-toggle="modal" data-target="#loginModal">Login</a>
                        <a href="#" class="btn btn-primary btn-sm mr-1 register-btn" data-toggle="modal" data-target="#registerModal">Register</a>
                        <a href="<?= base_url() ?>seller" class="btn btn-outline-success btn-sm seller-btn">
                    ...
                    <div id="logged-in-buttons" style="display: none;">
                        <div class="user-info mr-3">
                            ...
                            <strong id="logged-user-name">User</strong>
                        </div>
    ...
    <!-- Topbar End -->
                                                    ...
                                                    <form class="form-horizontal" method="GET" action="<?= isset($vendor_url) ? $vendor_url : LANG_URL ?>/category/<?= isset($_GET['category']) ? htmlspecialchars($_GET['category']) : '' ?>" id="bigger-search">
                                                        ...
                                                        <input type="hidden" name="brand_id" value="<?= isset($_GET['brand_id']) ? htmlspecialchars($_GET['brand_id']) : '' ?>"></form>
  ...
  <div id="navbar-vertical" class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" style="width: calc(100% - 30px); z-index: 999;">
    <?php
    function loop_tree($pages, $is_recursion = false)
    {
        ?>
        <div class="<?= $is_recursion === true ? 'dropdown-menu position-absolute rounded-0 border-0 m-0' : 'navbar-nav w-100' ?>">
            <?php
            foreach ($pages as $page) {
                ...
                ?>
                <div class="nav-item <?= $children === true ? 'dropdown dropright' : '' ?>">
                    <?php if ($children === true) { ?>
                        <a href="<?= LANG_URL ?>/category/<?= $page['id'] ?>"  data-categorie-id="<?= $page['id'] ?>" class="nav-link dropdown-toggle" data-toggle="dropdown">
                            <?= $page['name'] ?> <i class="fa fa-angle-right float-right mt-1"></i>
                        </a>
                        <?php loop_tree($page['children'], true); ?>
                    <?php } else { ?>
                        <a href="<?= LANG_URL ?>/category/<?= $page['id'] ?>"  class="nav-item nav-link" data-categorie-id="<?= $page['id'] ?>" ><?= $page['name'] ?></a>
                    <?php } ?>
                </div>
                <?php
            }
    ...
    ?>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <img src="<?= base_url('attachments/site_logo/' . $sitelogo) ?>" class="site-logo" alt="<?= $_SERVER['HTTP_HOST'] ?>" style="width:50px;">
                    <span style="color:red;font-size:large">Craft-</span><span style="color:#fff;font-size:large">Art.com</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a  href="<?= LANG_URL ?>" class="nav-item nav-link active">Home</a>
                            <a href="<?= LANG_URL . '/shopping-cart' ?>" class="nav-item nav-link">Shopping Cart</a>
                            <a href="<?= LANG_URL . '/checkout' ?>"class="nav-item nav-link">Checkout</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages <i class="fa fa-angle-down mt-1"></i></a>
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    
                                <a href="<?= LANG_URL . '/shopping-cart' ?>" class="dropdown-item">Shopping Cart</a>
                                    <a href="<?= LANG_URL . '/checkout' ?>" class="dropdown-item">Checkout</a>
                                </div>
                            </div>
                            <a href="<?= LANG_URL . '/contacts' ?>" class="nav-item nav-link">Contact</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="" class="btn px-0 ml-3 my-basket dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                <i class="fas fa-shopping-cart text-primary"></i>
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;"><span class="sumOfItems"><?= is_numeric($cartItems) && (int)$cartItems == 0 ? 0 : $sumOfItems ?></span> </span>
  </a><div class="bag-info"> 
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <p class="mb-0">Don't have an account? 
                            <a href="#" class="text-primary" data-dismiss="modal" data-toggle="modal" data-target="#registerModal">Sign up here</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="registerForm">
                        ...
                        <div class="form-group">
                            <label for="userType">
                                <i class="fas fa-users mr-1"></i>User Type
                            </label>
                    ...
                    <div class="text-center">
                        <p class="mb-0">Already have an account? 
                            <a href="#" class="text-primary" data-dismiss="modal" data-toggle="modal" data-target="#loginModal">Login here</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        function updateAuthButtons(user) {
            if (user) {
                ...
                $('#logged-user-name').text(user.username);
            } else {
                // User is logged out
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.logged_in) {
                        updateAuthButtons(response.user);
                    } else {
        ...
        function showNotification(message, type) {
            ...
            const notification = $('<div class="alert alert-' + (type === 'success' ? 'success' : 'danger') + ' alert-dismissible fade show notification-popup" role="alert">' +
                message +
        ...
        $('#registerUsername').on('blur', function() {
            ...
            if (username) {
                if (validateUsername(username)) {
                    ...
                    $.ajax({
                        url: '<?= base_url() ?>api/auth/check_username/' + encodeURIComponent(username),
                        type: 'GET',
                        dataType: 'json',
                        success: function(response) {
                            if (response.exists) {
                                showFieldError('registerUsername', 'Username is already taken');
                            } else {
                                showFieldSuccess('registerUsername');
                            }
                        },
                        error: function() {
                            showFieldSuccess('registerUsername'); // Assume available if check fails
                        }
                    });
                } else {
                    showFieldError('registerUsername', 'Username must be at least 3 characters and contain only letters, numbers, and underscores');
                }
            } else {
                clearFieldValidation('registerUsername');
            }
        });
        ...
        $('#registerEmail').on('blur', function() {
            ...
            if (email) {
                if (validateEmail(email)) {
                    ...
                    $.ajax({
                        url: '<?= base_url() ?>api/auth/check_email/' + encodeURIComponent(email),
                        type: 'GET',
                        dataType: 'json',
                        success: function(response) {
                            if (response.exists) {
                                showFieldError('registerEmail', 'Email is already registered');
                            } else {
                                showFieldSuccess('registerEmail');
                            }
                        },
                        error: function() {
                            showFieldSuccess('registerEmail'); // Assume available if check fails
                        }
                    });
                } else {
            ...
            if (isValid) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            // Success - update UI to logged in state
                            updateAuthButtons(response.user);
                            ...
                            showNotification('Login successful! Welcome back, ' + response.user.username, 'success');
                        } else {
                            // Show error message
        ...
        $('#registerForm').on('submit', function(e) {
            ...
            if (isValid) {
                ...
                // Make AJAX call to registration API
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            showNotification('Registration successful! Welcome, ' + response.data.username + '! You can now login with your credentials.', 'success');
                            ...
                            setTimeout(function() {
                                ...
                                $('#loginEmail').val(email); // Pre-fill email
                            }, 500);
                        } else {
                            // Show validation errors
                            if (response.errors && response.errors.length > 0) {
                                let errorMessage = response.errors.join('<br>');
                                showNotification('Registration failed:<br><br>' + errorMessage, 'error');
                            } else {
