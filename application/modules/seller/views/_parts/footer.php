...
<script>
    var urls = {
        changePass: '<?= base_url('seller/changePass') ?>',
        editShopCategorie: '<?= base_url('seller/editshopcategorie') ?>',
        changeTextualPageStatus: '<?= base_url('seller/changePageStatus') ?>',
        removeSecondaryImage: '<?= base_url('seller/removeSecondaryImage') ?>',
        productstatusChange: '<?= base_url('seller/productstatusChange') ?>',
        productsOrderBy: '<?= base_url('seller/products?orderby=') ?>',
        productStatusChange: '<?= base_url('seller/productStatusChange') ?>',
        changeOrdersOrderStatus: '<?= base_url('seller/changeOrdersOrderStatus') ?>',
        ordersOrderBy: '<?= base_url('seller/orders?order_by=') ?>',
        uploadOthersImages: '<?= base_url('seller/uploadOthersImages') ?>',
        loadOthersImages: '<?= base_url('seller/loadOthersImages') ?>',
        editPositionCategorie: '<?= base_url('seller/changePosition') ?>'
    };
</script>
