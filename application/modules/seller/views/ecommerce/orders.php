...
<div>
    ...
    <?php } else { ?>
        <a href="<?= base_url('seller/orders') ?>" class="pull-right orders-settings"><i class="fa fa-angle-left" aria-hidden="true"></i> <span>Back</span></a>
    <?php } ?>
</div>
<hr>
                    ...
                    foreach ($orders as $tr) {
                        ...
                        <tr>
                            ...
                            <a href="javascript:void(0);" class="btn btn-default more-info" data-toggle="modal" data-target="#modalPreviewMoreInfo" style="margin-top:10%;" data-more-info="<?= $tr['order_id'] ?>">
                                ...
                                <a href="<?= base_url('/seller/orders/delete/'. $tr['id']) ?>" onclick="return confirm('Are you sure want to delete this order?')" class="btn btn-danger" style="margin-top:10%;">
                                    Delete 
