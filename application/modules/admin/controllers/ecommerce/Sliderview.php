...
class Sliderview extends ADMIN_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('Slider_model', 'Languages_model', 'Categories_model'));
    }
    ...
    public function index($page = 0)
    {
        ...
        $data['slider'] = $this->Slider_model->getproducts($this->num_rows, $page, $search_title, $orderby, $category, $vendor);
        $data['links_pagination'] = pagination('admin/slider', $rowscount, $this->num_rows, 3);
        ...
        $this->load->view('ecommerce/sliderview', $data);
