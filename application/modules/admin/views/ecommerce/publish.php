...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    <input 
        type="number" 
        name="price[]" 
        placeholder="without currency at the end" 
...
<div class="form-group for-shop">
    ...
    <div class="form-group for-shop">
        ...
        step="1" placeholder="number" name="quantity" value="<?= isset($_POST['quantity']) ? htmlspecialchars($_POST['quantity']) : '' ?>" class="form-control" id="quantity" required>
    </div>
    <?php if ($showBrands == 1) { ?>
        <div class="form-group for-shop">
            <label>Brand</label>
...
$(document).ready(function() {
    const $inputs = $('input[name="price[]"], input[name="old_price[]"], input[name="quantity[]"]');
    ...
    // Clean up invalid input in case of browser auto-fill or programmatic changes
    $inputs.on('input', function() {
        let val = $(this).val();

        // Remove any non-numeric characters except one "."
