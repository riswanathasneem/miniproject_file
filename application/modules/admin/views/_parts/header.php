                        ...
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li><a href="<?= base_url('admin/slider') ?>" <?= urldecode(uri_string()) == 'admin/slider' ? 'class="active"' : '' ?>><i class="fa fa-files-o" aria-hidden="true"></i> <?= "Add SLider" ?></a></li>
                                    <li><a href="<?= base_url('admin/sliderview') ?>" <?= urldecode(uri_string()) == 'admin/sliderview' ? 'class="active"' : '' ?>><i class="fa fa-files-o" aria-hidden="true"></i> <?= "Update Slider"?></a></li>
                                    <?php if ($showBrands == 1) { ?>
