...
<footer>Powered by <a href="""">Hazitech</a></footer>
<?php } ?>
</div>
<!-- Modal Calculator -->
...
<script>
    var urls = {
        changePass: '<?= base_url('delivery_agent/changePass') ?>',
        editShopCategorie: '<?= base_url('delivery_agent/editshopcategorie') ?>',
        changeTextualPageStatus: '<?= base_url('delivery_agent/changePageStatus') ?>',
        removeSecondaryImage: '<?= base_url('delivery_agent/removeSecondaryImage') ?>',
        productstatusChange: '<?= base_url('delivery_agent/productstatusChange') ?>',
        productsOrderBy: '<?= base_url('delivery_agent/products?orderby=') ?>',
        productStatusChange: '<?= base_url('delivery_agent/productStatusChange') ?>',
        changeOrdersOrderStatus: '<?= base_url('delivery_agent/changeOrdersOrderStatus') ?>',
        ordersOrderBy: '<?= base_url('delivery_agent/orders?order_by=') ?>',
        uploadOthersImages: '<?= base_url('delivery_agent/uploadOthersImages') ?>',
        loadOthersImages: '<?= base_url('delivery_agent/loadOthersImages') ?>',
        editPositionCategorie: '<?= base_url('delivery_agent/changePosition') ?>'
    };
</script>
