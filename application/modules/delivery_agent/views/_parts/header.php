                    ...
                    <nav class="navbar navbar-default" style="background-color: #2d8e9b;">
                        ...
                        <div id="navbar" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li><a href="<?= base_url('delivery_agent') ?>"><i class="fa fa-home"></i> <?= lang('home') ?></a></li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="<?= base_url('delivery_agent/logout') ?>"><i class="fa fa-sign-out"></i> <?= lang('logout'); ?></a></li>
                            </ul>
                        </div>
                    </nav>
                <?php } ?>
                                ...
                                <ul class="sidebar-menu">
                                    <!-- <li class="sidebar-search">
                                        <div class="input-group custom-search-form">
                                            <form method="GET" action="<?= base_url('delivery_agent/products') ?>">
                                                <div class="input-group">
                                    ...
                                    <!-- <li><a href="<?= base_url('delivery_agent/publish') ?>" <?= urldecode(uri_string()) == 'delivery_agent/publish' ? 'class="active"' : '' ?>><i class="fa fa-edit" aria-hidden="true"></i> <?= lang('publish_product') ?></a></li>
                                    <li><a href="<?= base_url('delivery_agent/products') ?>" <?= urldecode(uri_string()) == 'delivery_agent/products' ? 'class="active"' : '' ?>><i class="fa fa-files-o" aria-hidden="true"></i> <?= lang('products') ?></a></li>
                                    <li><a href="<?= base_url('delivery_agent/slider') ?>" <?= urldecode(uri_string()) == 'delivery_agent/slider' ? 'class="active"' : '' ?>><i class="fa fa-files-o" aria-hidden="true"></i> <?= "Add SLider" ?></a></li>
                                    <li><a href="<?= base_url('delivery_agent/sliderview') ?>" <?= urldecode(uri_string()) == 'delivery_agent/sliderview' ? 'class="active"' : '' ?>><i class="fa fa-files-o" aria-hidden="true"></i> <?= "Update Slider"?></a></li> -->
                                    <?php //if ($showBrands == 1) { ?>
                                        <!-- <li><a href="<?= base_url('delivery_agent/brands') ?>" <?= urldecode(uri_string()) == 'delivery_agent/brands' ? 'class="active"' : '' ?>><i class="fa fa-registered" aria-hidden="true"></i> <?= lang('brands') ?></a></li> -->
                                    <?php //} ?>
                                    <!-- <li><a href="<?= base_url('delivery_agent/shopcategories') ?>" <?= urldecode(uri_string()) == 'delivery_agent/shopcategories' ? 'class="active"' : '' ?>><i class="fa fa-list-alt" aria-hidden="true"></i> <?= lang('shop_categories') ?></a></li> -->
                                    <li>
                                        <a href="<?= base_url('delivery_agent/orders') ?>" <?= urldecode(uri_string()) == 'delivery_agent/orders' ? 'class="active"' : '' ?>>
