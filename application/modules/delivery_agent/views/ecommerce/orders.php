...
<div>
    ...
    <?php } else { ?>
        <a href="<?= base_url('delivery_agent/orders') ?>" class="pull-right orders-settings"><i class="fa fa-angle-left" aria-hidden="true"></i> <span>Back</span></a>
    <?php } ?>
</div>
<hr>
                    ...
                    foreach ($orders as $tr) {
                        ...
                        <tr>
                            ...
                            <td class="<?= $class ?> text-center" data-action-id="<?= $tr['id'] ?>">
                                ...
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 1, '<?= htmlentities($tr['products']) ?>', '<?= $tr['email'] ?>')" class="btn btn-success btn-xs">Delivered</a></div>
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 0)" class="btn btn-danger btn-xs">In transist</a></div>
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 2)" class="btn btn-warning btn-xs">Pick up</a></div>
                            </td>
                            ...
                            <a href="javascript:void(0);" class="btn btn-default more-info" data-toggle="modal" data-target="#modalPreviewMoreInfo" style="margin-top:10%;" data-more-info="<?= $tr['order_id'] ?>">
                                ...
                                <a href="<?= base_url('/delivery_agent/orders/delete/'. $tr['id']) ?>" onclick="return confirm('Are you sure want to delete this order?')" class="btn btn-danger" style="margin-top:10%;">
                                    Delete 
